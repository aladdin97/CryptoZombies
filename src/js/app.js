App = {
     ...
     displayZombie: function (id, name, dna, level, readyTime, winCount, lossCount) {
          ...
          var hex_colour = '#' + App.randomHex(dna);
          var comp_hex_colour = '#' + App.invertHex(hex_colour);
          zombieTemplate.find('.panel-heading').attr('style','background-color:'+hex_colour+';color:'+comp_hex_colour);
     ...
     randomHex: function (dna) {
          ...
          var dnaHex = dna.toString(16);
          return dnaHex.slice(0,6);
     
     },

     invertHex: function (Hex) {
          var compHex = 0xffffff ^ parseInt(Hex,16);
          return compHex.toString(16);
     },
